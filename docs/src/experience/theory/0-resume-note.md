...
之前的工作主要是 HR 相关业务的开发，后面想在前端工程化，Node应用这一块继续努力，进一步提升自己的专业能力。同时，在某一个业务领域进行深耕，利用技术更好的为业务赋能。

## 你的核心竞争力是什么？我们为什么录用你？

* 知识涉猎比较广，学习能力强，对于不熟悉的工作内容能够快速上手。

* 情绪稳定，性格好，能够与大家打成一片，更好的进行协作。

## 如何评价自己

## 工作中遇到最大的问题，如何解决的

开发 OKR 项目时，我们面临了诸多挑战，因为是我们新团队对于业务方第一个交付的系统，交付时间紧张的同时对项目质量要求还很高。

面对这些问题，我首先梳理了所有模块，然后对各个功能点进行拆分，设置单独的ddl。

正式开发之后，每天进行5分钟的站立会议，check 项目进度。

开发过程中定期进行CR，提测前对整个流程进行测试，确保提测质量。

在人力实在无法 cover 时，与 +1 进行沟通紧急抽调人力支持。
...
在人力实在无法 cover 时，与 +1 进行沟通抽调人力支持。
